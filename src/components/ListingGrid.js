...
function ListingGrid({ listingsUpdated }) {
  ...
  useEffect(() => {
    fetchListings();
  }, [listingsUpdated]); // Re-fetch when listingsUpdated changes
      ...
      const formattedListings = data
        .map((listing) => {
          ...
          return {
            ...
            monthlyRate: Number(listing.monthlyRate) || 0,
    ...
    <div className="listing-grid-container">
      ...
      <div className="content-wrapper">
        <div className="main-content">
          ...
          <h2>Upgrade your office with Sunny Khurana & team</h2>
          <div className="expert-info">
            <img src="/images/expert-profile.svg" alt="Expert" className="expert-image" />
            <div className="expert-details">
              <h3>Connect with Us</h3>
              <p className="expert-phone">8130343802</p>
              <div className="expert-badge">JustOfis Expert</div>
            </div>
            <button className="contact-expert" onClick={() => window.location.href='tel:+918130343802'}>
              Contact Us
            </button>
          </div>
